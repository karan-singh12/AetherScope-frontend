      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">
            Create your LLM Observability account
          </p>
        </div>
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-2xl bg-gradient-to-r from-sky-600 to-sky-500 px-4 py-3 font-semibold text-white transition hover:shadow-lg hover:from-sky-500 hover:to-sky-400 disabled:cursor-not-allowed disabled:opacity-50"
          >
            {loading ? (
